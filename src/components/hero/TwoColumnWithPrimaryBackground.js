...
const PrimaryBackgroundContainer = tw.div`-mx-8 px-8 bg-orange-900 text-gray-100`;
...
const PrimaryLink = tw(
  PrimaryLinkBase
)`shadow-raised lg:bg-orange-400 lg:hocus:bg-gold-950`;
...
const PrimaryButton = tw(
  PrimaryButtonBase
)`mt-8 text-sm sm:text-base px-6 py-5 sm:px-10 sm:py-5 bg-orange-400 inline-block hocus:bg-gold-950`;
