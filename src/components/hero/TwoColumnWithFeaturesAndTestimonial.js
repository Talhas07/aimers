...
const Heading = tw(
  SectionHeading
)`text-left text-orange-900 leading-snug xl:text-6xl`;
...
const FeatureIcon = tw(CheckboxIcon)`w-5 h-5 text-gold-950`;
...
`;
const Testimonial = tw.div`max-w-sm rounded-b md:rounded-none relative sm:absolute bottom-0 inset-x-0 z-20 px-8 py-6 sm:px-10 sm:py-8 bg-orange-900 text-gray-400 font-medium transform md:-translate-x-32 text-sm leading-relaxed md:-mr-16 xl:mr-0`;
