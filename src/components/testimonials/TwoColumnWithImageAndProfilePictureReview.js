...
const CustomerName = tw.h5`font-semibold text-xl lg:text-2xl xl:text-3xl text-gold-950`;
const CustomerTitle = tw.p`font-medium text-secondary-100`;

const QuotesLeft = tw(
  QuotesLeftIcon
)`w-6 h-6 opacity-75 text-gold-950 inline-block mr-1 -mt-3`;
const QuotesRight = tw(
  QuotesRightIcon
)`w-6 h-6 opacity-75 text-gold-950 inline-block ml-1 -mt-3`;
