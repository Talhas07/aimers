...
const Details = tw.div`p-6 rounded border-2 border-t-0 rounded-t-none border-dashed border-orange-100 flex-1 flex flex-col items-center text-center lg:block lg:text-left`;
...
export default ({
  ...
  heading = (
    <>
      We Love <span tw="text-gold-950">Writing.</span>
    </>
  ),
