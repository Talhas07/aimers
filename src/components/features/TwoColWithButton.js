...
import TeamIllustrationSrc from "images/building.png";
...
const DecoratorBlob = styled(SvgDotPattern)((props) => [
  tw`w-20 h-20 absolute right-0 bottom-0 transform translate-x-1/2 translate-y-1/2 fill-current text-gold-950 -z-10`,
]);
