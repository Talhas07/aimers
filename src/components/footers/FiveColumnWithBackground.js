...
const Container = tw.div`relative bg-gold-950 text-gray-100 -mb-8 -mx-8 px-8 py-10 lg:py-12`;
...
const Divider = tw.div`my-16 border-b-2 border-orange-400 w-full`;
...
const DecoratorBlob1 = tw(
  SvgDecoratorBlob1
)`absolute top-0 left-0 w-80 h-80 transform -translate-x-20 -translate-y-32 text-orange-700 opacity-50`;
const DecoratorBlob2 = tw(
  SvgDecoratorBlob1
)`absolute bottom-0 right-0 w-80 h-80 transform  translate-x-32 translate-y-48 text-orange-700 opacity-50`;
