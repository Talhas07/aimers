...
const PrimaryBackgroundContainer = tw.div`py-20 lg:py-24 bg-gold-950 rounded-lg relative`;
...
const SecondaryLink = tw(
  Link
)`text-gray-100 border-gray-500 hover:bg-gray-100 hover:text-gold-950 hover:border-gold-950`;

const DecoratorBlobContainer = tw.div`absolute inset-0 overflow-hidden rounded-lg`;
const DecoratorBlob1 = tw(
  SvgDecoratorBlob1
)`absolute bottom-0 left-0 w-80 h-80 transform -translate-x-20 translate-y-32 text-orange-700 opacity-50`;
