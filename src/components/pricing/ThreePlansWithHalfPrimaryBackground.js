...
const Container = tw(ContainerBase)`bg-orange-900 text-gray-100 -mx-8 px-8`;
...
const PlanFeatures = styled.ul`
  ...
  .feature {
    ...
    .icon {
      ${tw`w-6 h-6 text-gold-950 flex-shrink-0`}
    }
    .text {
      ${tw`font-semibold text-orange-900 tracking-wide ml-3`}
    }
  }
`;
...
const ActionButton = styled(PrimaryButtonBase)`
  ${tw`block text-center text-sm font-semibold tracking-wider w-full text-gray-100 bg-gold-950 px-6 py-4 rounded hover:bg-orange-700 focus:shadow-outline focus:outline-none transition-colors duration-300`}
`;
