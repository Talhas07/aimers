...
const PrimaryNavLink = tw(
  NavLink
)`text-gray-100 bg-gold-950 px-6 py-3 border-none rounded hocus:bg-orange-900 focus:shadow-outline`;
const HeroRow = tw(
  Row
)`max-w-xl flex-col justify-between items-center py-20 lg:py-24 mx-auto`;

const Heading = tw(HeadingBase)`text-center text-orange-900 leading-snug`;
